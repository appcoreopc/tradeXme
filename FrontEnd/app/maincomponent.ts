...
import { TrademeHeaderComponent } from 'app/trademeHeader';
import { TrademeCategoryBarComponent } from 'app/trademeCategoryBarComponent';
import { TrademeFooterComponent } from 'app/trademeFooterComponent';

@Component({
selector: 'my-app',
templateUrl : 'app/app.component.html',
  directives: [TimeSheetEntryComponent, TrademeHeaderComponent, TrademeCategoryBarComponent, TrademeFooterComponent]
})
